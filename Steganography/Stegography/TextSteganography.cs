...
#pragma warning disable CS8604 // Mögliches Nullverweisargument.
  ...
  public static Image? EmbeddingTextNaive(StegoInfo steginfo)
  {
    AssertEmbedding(steginfo, false);
    var basicimg = (Bitmap)LoadImage(steginfo.BasicImagePath);
    var csc = CheckStorageCapacities(basicimg, steginfo.HideText);
    var header = ToHeader(csc.RequiredCapacity, false);
    ...
    var cipher = AesEncryption(steginfo.Password, steginfo.HideText);
  ...
  public static Image? EmbeddingText(StegoInfo steginfo)
  {
    AssertEmbedding(steginfo, false);
    var basicimg = (Bitmap)LoadImage(steginfo.BasicImagePath);
    var csc = CheckStorageCapacities(basicimg, steginfo.HideText);
  ...
  public static byte[] ExtractTextNaive(StegoInfo steginfo)
  {
    AssertExtract(steginfo, false);
    ...
    jump:
    return AesDecryptionText(steginfo.Password, cipher);
  }

  public static byte[] ExtractText(StegoInfo steginfo)
  {
    AssertExtract(steginfo, false);
